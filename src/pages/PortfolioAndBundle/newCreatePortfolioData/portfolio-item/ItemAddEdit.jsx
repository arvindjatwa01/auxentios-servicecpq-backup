      ...
      if (itemBodyModel.itemPrices.length !== 0) {
        ...
        if (itemPriceDetails.status === 200) {
          ...
          setItemPriceRequestObj({
            ...
            portfolio: isEmpty(itemPriceDetails.data.portfolio?.portfolioId)
              ? null
    ...
    try {
      let priceReqObj = {
        ...
        discountType: !isEmpty(itemPriceRequestObj.discountType)
          ...
          : "PORTFOLIO_DISCOUNT",
        portfolio: isEmpty(itemPriceRequestObj.portfolio?.portfolioId)
          ? null
      ...
      if (!itemPriceDataId || itemPriceDataId === "") {
        ...
        if (updateItemPrice.status === 200) {
          ...
          setItemPriceRequestObj({
            ...
            frequency: _frequency || "",
            usageUnit: _usageUnit || "",
            portfolio: isEmpty(updateItemPrice.data.portfolio?.portfolioId)
              ? null
        ...
        if (createItemPrice.status === 200) {
          ...
          setItemPriceRequestObj({
            ...
            portfolio: isEmpty(createItemPrice.data.portfolio?.portfolioId)
              ? null
          ...
          <TabContext value={itemActiveTab}>
            ...
            >
              <TabList
                ...
                onChange={(e, activeItemTab) => setItemActiveTab(activeItemTab)}
              >
