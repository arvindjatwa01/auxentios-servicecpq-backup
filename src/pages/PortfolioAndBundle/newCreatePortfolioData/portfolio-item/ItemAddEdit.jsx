...
const ItemAddEdit = (props) => {
    ...
    // map item details
    const handlemapItemDetails = async (responseData) => {
        ...
        if (itemBodyModel.itemPrices.length !== 0) {
            ...
            //     .itemPriceDataId
            // );
            const itemPriceDetails = await getItemPriceData(_itemPriceDataId);
            if (itemPriceDetails.status === 200) {
                ...
                setItemPriceRequestObj({
                    ...
                    portfolio: isEmpty(portfolioId)
                        ? isEmpty(itemPriceDetails.data.portfolio?.portfolioId)
                            ? null
                            : Object.keys(itemPriceDetails.data.portfolio)
                                  .length === 0
                            ? null
                            : itemPriceDetails.data.portfolio
    ...
    const handleGetItemDetails = async (itemId) => {
        ...
        if (itemDetails.status === 200) {
            ...
            dispatch(taskActions.updateList(itemBodyModel.usageIn));
            // dispatch(taskActions.updateList(_usageIn));
            const _strategyTask = strategyTaskKeyValuePair.find(
                (obj) => obj.value === itemHeaderModel.itemHeaderStrategy
            );

            dispatch(
                taskActions.updateTask(itemHeaderModel.itemHeaderStrategy)
            );
            // dispatch(taskActions.updateTask(_strategyTask));
            const _taskType = taskTypeKeyValuePair.find(
                (obj) => obj.value === itemBodyModel.taskType[0]
            );
            const _usageType = usageTypeKeyValuePair.find(
            ...
            if (itemBodyModel.itemPrices.length !== 0) {
                ...
                if (itemPriceDetails.status === 200) {
                    ...
                    setItemPriceRequestObj({
                        ...
                        portfolio: isEmpty(portfolioId)
                            ? isEmpty(
                                  itemPriceDetails.data.portfolio?.portfolioId
                              )
                                ? null
                                : Object.keys(itemPriceDetails.data.portfolio)
                                      .length === 0
    ...
    const checkInputValidation = (isItem) => {
        if (itemActiveTab === "itemSummary") {
            if (isItem && isPortfolioItem && isEmpty(portfolioId)) {
                ...
                errorMessage(
                    "Usage In is a required field, you can’t leave it blank"
                );
                return false;
            } else if (isItem && isEmpty(isItem && itemRequestObj.taskType)) {
                errorMessage(
                    "Task Type is a required field, you can’t leave it blank"
                );
                return false;
                ...
                errorMessage(
                    "End Usage is a required field, you can’t leave it blank"
                );
                return false;
                ...
                errorMessage(
                    "Unit is a required field, you can’t leave it blank"
                );
                return false;
            } else if (
        ...
        try {
            let priceReqObj = {
                ...
                discountType: !isEmpty(itemPriceRequestObj.discountType)
                    ...
                    : "PORTFOLIO_DISCOUNT",
                portfolio: isEmpty(portfolioId)
                    ? isEmpty(itemPriceRequestObj.portfolio?.portfolioId)
                        ? null
                        : Object.keys(itemPriceRequestObj.portfolio).length ===
                          0
                        ? null
                ...
                numberOfEvents:
                    itemType === "portfolioItem"
                        ? itemPriceRequestObj?.numberOfEvents || 1
            ...
            if (!itemPriceDataId || itemPriceDataId === "") {
                ...
                if (updateItemPrice.status === 200) {
                    ...
                    setItemPriceRequestObj({
                        ...
                        portfolio: isEmpty(portfolioId)
                            ? isEmpty(
                                  updateItemPrice.data.portfolio?.portfolioId
                              )
                                ? null
                                : Object.keys(updateItemPrice.data.portfolio)
                                      .length === 0
                                ? null
                                : updateItemPrice.data.portfolio
                            : { portfolioId: portfolioId },
                    });
                    setItemRequestObj({
                        ...itemRequestObj,
                ...
                if (createItemPrice.status === 200) {
                    ...
                    setItemPriceRequestObj({
                        ...
                        portfolio: isEmpty(portfolioId)
                            ? isEmpty(
                                  createItemPrice.data.portfolio?.portfolioId
                              )
                                ? null
                                : Object.keys(createItemPrice.data.portfolio)
                                      .length === 0
                                ? null
                                : createItemPrice.data.portfolio
                            : { portfolioId: portfolioId },
                    });
                    setItemRequestObj({
                        ...itemRequestObj,
                    ...
                    <TabContext value={itemActiveTab}>
                        ...
                        >
                            <TabList
                                ...
                                onChange={(e, activeItemTab) =>
                                    isEditable &&
                                    setItemActiveTab(activeItemTab)
                                }
                            >
                                <Tab
                                    label="Item Summary(s)"
                                    value="itemSummary"
                                />
                                            ...
                                            <div className="col-md-6 col-sm-6">
                                                <div className="form-group">
                                                    ...
                                                    <Select
                                                        className="text-primary"
                                                        options={
                                                            taskTypeKeyValuePair
                                                        }
                                                        value={
                                                            itemRequestObj.taskType
                                                        }
                                                        onChange={(e) =>
                                                            handleSelectChange(
                                                                e,
                      ...
                      c0.1,5.5,3.5,9.2,8.4,9.2c4.9,0,8.4-3.8,8.4-9.2C193.8,38.7,193.8,26.3,193.7,13.9z"
                                            ...
                                            />
                                            {
                                                ...
                                                >
                                                    ...
                                                    searchedStandardJobIdList.length ===
                                                        0 ? (
                                                        <li className="list-group-item">
                                                            No Record Found
                                                        </li>
                                                    ) : (
                                                        searchedStandardJobIdList.map(
                                                            (
                                                                currentItem,
                                                                i
                                                            ) => (
                      ...
                      c0.1,5.5,3.5,9.2,8.4,9.2c4.9,0,8.4-3.8,8.4-9.2C193.8,38.7,193.8,26.3,193.7,13.9z"
                                            ...
                                            />
                                            {
                                                ...
                                                >
                                                    ...
                                                    searchedRepairKitIdList.length ===
                                                        0 ? (
                                                        <li className="list-group-item">
                                                            No Record Found
                                                        </li>
                                                    ) : (
                                                        searchedRepairKitIdList.map(
                                                            (
                                                                currentItem,
                                                                i
                                                            ) => (
