...
export const PortfolioSummary = () => {
    ...
    useEffect(() => {
        ...
        getSearchForRecentPortfolio()
            .then((res) => {
                if (res.status === 200) { setRecentPortfolios(res.data) }
            })
            .catch((error) => {
                return;
            })
        ...
        recentItemsList("BUNDLE_ITEM")
            .then((res) => {
                if (res.status === 200) { setRecentBundles(res.data); }
            })
            .catch((error) => {
                return;
            })
        ...
        recentItemsList("SERVICE")
            .then((res) => {
                if (res.status === 200) { setRecentServices(res.data); }
            })
            .catch((error) => {
                return;
            })
    ...
    const handleCheckDisableOptions = (option) => {
        if (searchParameter.length > 1) {
            if ((searchParameter[0].selectFamily.value === "name") || (searchParameter[0].selectFamily.value === "description")) {
    ...
    const handleSelectFamily = (e, i) => {
        const _searchParameter = [...searchParameter];
        const updateObj = { ..._searchParameter[i], inputSearch: "", selectOptions: [], selectFamily: e }
    ...
    const handleSearchDropdownData = (e, id) => {
        ...
        if (e.target.value.length > 0) {
            if (_searchParameter[0].itemType?.value === "PORTFOLIO") {
                if (_searchParameter[id].selectFamily.value === "name" || _searchParameter[id].selectFamily.value === "description") {
                    portfolioSearchDropdownList(`${_searchParameter[id].selectFamily.value}/${e.target.value}`)
                        .then((res) => {
                            if (res.status === 200) {
                    ...
                    getSearchCoverageForFamily(_searchParameter[id].selectFamily.value, e.target.value)
                        .then((res) => {
                ...
                let searchUrl = _searchParameter[id].selectFamily.value + "/" + e.target.value + "?bundle_flag=" + _searchParameter[0].itemType?.value;
    ...
    const handleSelectDropdownItem = (currentItem, id) => {
        const _searchParameter = [...searchParameter];
        let obj = _searchParameter[id];
        obj.inputSearch = searchParameter[0].itemType?.value === "PORTFOLIO" && obj.selectFamily.value !== "name" &&
            obj.selectFamily.value !== "description" ? currentItem : currentItem.split("#")[1];
        obj.selectedOption = searchParameter[0].itemType?.value === "PORTFOLIO" && obj.selectFamily.value !== "name" &&
            obj.selectFamily.value !== "description" ? currentItem : currentItem.split("#")[1];
        obj.selectedKeyValue = searchParameter[0].itemType?.value === "PORTFOLIO" && obj.selectFamily.value !== "name" &&
            obj.selectFamily.value !== "description" ? currentItem : currentItem.split("#")[0];
        _searchParameter[id] = obj;
        setSearchParameter([..._searchParameter]);
    ...
    const handleSearchData = async () => {
        try {
            ...
            if (searchParameter[0].itemType?.value === "PORTFOLIO") {
                searchUrl = (searchParameter[0]?.selectFamily?.value === "name" || searchParameter[0]?.selectFamily?.value === "description") ?
                    "portfolio_id=" + searchParameter[0]?.selectedKeyValue : searchParameter[0]?.selectFamily?.value + "=" + searchParameter[0]?.inputSearch
            } else {
            ...
            for (let i = 1; i < searchParameter.length; i++) {
                ...
                if (searchParameter[0].itemType?.value === "PORTFOLIO") {
                    searchUrl = searchUrl + "&" + (searchParameter[0]?.selectFamily?.value === "name" || searchParameter[0]?.selectFamily?.value === "description") ?
                        "portfolio_id=" + searchParameter[i]?.selectedKeyValue : searchParameter[i]?.selectFamily?.value + "=" + searchParameter[i]?.inputSearch
                } else {
                    searchUrl = searchUrl + " " + searchParameter[i]?.selectOperator.value + " " + searchParameter[i]?.selectFamily?.value
    ...
    const portfolioColumns = [
        ...
        },
        {
            ...
            cell: (row, i) => (<div>
                <a className='cursor' onClick={() => viewPortfolioDetails(row)}> <EditOutlinedIcon /></a>
            </div>),
        },
    ]
    ...
    const viewRecentPortfolio = () => (
        <div className="mt-1">
            <div className="recent-div p-3">
                <h6 className="font-weight-600 text-grey mb-0 text-uppercase">RECENT PORTFOLIO</h6>
                <div className="row">
                    {recentPortfolios.length !== 0 && recentPortfolios.map((portfolio, i) => i < 10 &&
                            ...
                            <div className="recent-items mt-3">
                                <div className="d-flex justify-content-between align-items-center ">
                                    <p className="mb-0 overflow-hidden white-space">
                                        ...
                                        <span className="font-weight-500 ml-2">{portfolio.name}</span>
                                    </p>
                                    <div className="d-flex align-items-center">
                                        <a className="btn-sm cursor" onClick={() => viewPortfolioDetails(portfolio)}>
                    ...
                    {recentPortfolios.length === 0 && <p className="font-size-12 mb-0 ml-3">No Recent Portfolio</p>}
                </div>
            </div>
        </div>
    )
    ...
    const viewRecentServices = () => (
        <div className="mt-1">
            <div className="recent-div p-3">
                <h6 className="font-weight-600 text-grey mb-0 text-uppercase">RECENT SERVICE</h6>
                <div className="row">
                    {recentServices.length !== 0 && recentServices.map((service, i) => i < 10 &&
                        <div className="col-md-4" key={"service-" + i}>
                            <div className="recent-items mt-3">
                                <div className="d-flex justify-content-between align-items-center ">
                                    <p className="mb-0 overflow-hidden white-space">
                                        <FontAwesomeIcon className=" font-size-14" icon={faFileAlt} />
                                        <span className="font-weight-500 ml-2">{service.itemName}</span>
                                    </p>
                                    <div className="d-flex align-items-center">
                    ...
                    {recentServices.length === 0 && <p className="font-size-12 mb-0 ml-3">No Recent Service</p>}
                </div>
            </div>
        </div>
    )
    ...
    const viewRecentBundles = () => (
        <div className="mt-1">
            <div className="recent-div p-3">
                <h6 className="font-weight-600 text-grey mb-0 text-uppercase">RECENT BUNDLE</h6>
                <div className="row">
                    {recentBundles.length !== 0 && recentBundles.map((bundle, i) => i < 10 &&
                        <div className="col-md-4" key={"bundle-" + i}>
                            <div className="recent-items mt-3">
                                <div className="d-flex justify-content-between align-items-center ">
                                    <p className="mb-0 overflow-hidden white-space">
                                        <FontAwesomeIcon className=" font-size-14" icon={faFileAlt} />
                                        <span className="font-weight-500 ml-2">{bundle.itemName}</span>
                                    </p>
                                    <div className="d-flex align-items-center">
                                        <a className="btn-sm cursor">
                    ...
                    {recentBundles.length === 0 && <p className="font-size-12 mb-0 ml-3">No Recent Bundle</p>}
                </div>
            </div>
        </div>
    )
