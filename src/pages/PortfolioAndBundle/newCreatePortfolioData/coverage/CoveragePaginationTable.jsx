...
const CoveragePaginationTable = (props) => {
    ...
    const [showIncludedSerialNoModal, setShowIncludedSerialNoModal] = useState(false)
    const [includedCoverageSerialOptions, setIncludedCoverageSerialOptions] = useState([])
    ...
    const handleCoverageInputChange = (e, keyName, type) => {
        if (type === "text") {
            ...
            setEditCoverageData({ ...editCoverageData, [keyName]: parseInt(e.target.value) });
        } else if (type === "select") {
    ...
    const handleAddMoreSerialNoDataList = () => {
        ...
        obj = {
            ...obj, includedSerialNoModalData: [...obj.includedSerialNoModalData, {
                family: obj.family,
                model: obj.model,
                noSeriese: "",
                location: "",
    ...
    const handleIncludeSerialNoTextChange = (e, i, row, keyName) => {
        let _tableData = [...tableData]
        let tempObj = _tableData[selectedCoverageIndex].includedSerialNoModalData[i]
    ...
    const handleUpdateIncludedSerialNo = async (data) => {
        try {
            ...
            if (selectedRowObj.includedSerialNoModalData.length !== 0) {
                for (let i = 0; i < selectedRowObj.includedSerialNoModalData.length; i++) {
                    if (i !== 0) {
                        let reqObj = {
                            coverageId: 0,
                            serviceId: 0,
                            ...
                            serialNumber: selectedRowObj.includedSerialNoModalData[i].serialNumber ? selectedRowObj.includedSerialNoModalData[i].serialNumber : "",
                            startSerialNumber: "",
                            endSerialNumber: "",
                            serialNumberPrefix: "",
    ...
    const editCoverageDataModel = () => {
        return (
            <Modal show={showCoverageEditModal} onHide={handleCoverageEditModal} centered size="lg">
                <Modal.Header className="align-items-center">
                    <div><Modal.Title>Edit Coverage</Modal.Title></div>
                </Modal.Header>
                <Modal.Body className="included_table">
                    <div className="row input-fields">
                        <div className="col-md-4 col-sm-4">
                            <div className="form-group w-100">
                                <label className="text-light-dark font-size-14 font-weight-500">Coverage ID</label>
                                <input type="text" className="form-control border-radius-10 text-primary" disabled
                                    placeholder="(AUTO GENERATE)" value={editCoverageData.coverageId}
                                />
                            </div>
                        </div>
                        <div className="col-md-4 col-sm-4">
                            <div className="form-group">
                                <label className="text-light-dark font-size-14 font-weight-500">Make</label>
                                <input type="text" className="form-control text-primary border-radius-10" name="make"
                                    placeholder="Auto Fill Search Model...." value={editCoverageData.make} disabled
                                />
                            </div>
                        </div>
                        <div className="col-md-4 col-sm-4">
                            <div className="form-group">
                                <label className="text-light-dark font-size-14 font-weight-500">Family</label>
                                <input type="text" className="form-control text-primary border-radius-10" name="family"
                                    placeholder="Auto Fill Search Model...." value={editCoverageData.family} disabled
                                />
                            </div>
                        </div>
                        <div className="col-md-4 col-sm-4">
                            <div className="form-group">
                                <label className="text-light-dark font-size-14 font-weight-500">Model No</label>
                                <input type="text" className="form-control text-primary border-radius-10" name="model"
                                    placeholder="Model(Required*)" value={editCoverageData.modelNo} onChange={(e) => handleModelSearchInput(e)}
                                />
                                {<ul className={`list-group custommodelselectsearch customselectsearch-list scrollbar scrollbar-model style`} id="style">
                                    {searchedModalList.map((currentItem, j) => (
                                        <li className="list-group-item" key={j} onClick={() => handleSelectSearchModel(currentItem)}>
                                            {currentItem.model}
                                        </li>
                                    ))}
                                </ul>}
                        ...
                        <div className="col-md-4 col-sm-4">
                            <div className="form-group">
                                <label className="text-light-dark font-size-14 font-weight-500">Serial No Prefix</label>
                                <Select
                                    options={modalPrefixKeyValuePair}
                                    placeholder="Select..."
                                    value={editCoverageData.serialNoPrefix}
                                    className="text-primary"
                                    onChange={(e) => handleCoverageInputChange(e, "serialNoPrefix", "select")}
                                />
                            </div>
                        </div>
                        <div className="col-md-4 col-sm-4">
                            <div className="form-group">
                                <label className="text-light-dark font-size-14 font-weight-500">Start Serial No</label>
                                <input type="text" className="form-control border-radius-10 text-primary" placeholder="(Optional)"
                                    value={editCoverageData.startSerialNo}
                                    onChange={(e) => handleCoverageInputChange(e, "startSerialNo", "text")}
                                />
                            </div>
                        </div>
                        <div className="col-md-4 col-sm-4">
                            <div className="form-group">
                                <label className="text-light-dark font-size-14 font-weight-500">End Serial No</label>
                                <input type="text" className="form-control border-radius-10 text-primary" placeholder="(Optional)"
                                    value={editCoverageData.endSerialNo}
                                    onChange={(e) => handleCoverageInputChange(e, "endSerialNo", "text")}
                                />
                            </div>
                        </div>
                        <div className="col-md-4 col-sm-4">
                            <div className="form-group">
                                <label className="text-light-dark font-size-14 font-weight-500">Fleet</label>
                                <input type="text" className="form-control border-radius-10 text-primary" placeholder="(Optional)"
                        ...
                        <div className="col-md-4 col-sm-4">
                            <div className="form-group">
                                <label className="text-light-dark font-size-14 font-weight-500"> Fleet Size</label>
                                <input type="text" className="form-control border-radius-10 text-primary" placeholder="(Optional)"
                                    value={editCoverageData.fleetSize}
                                    onChange={(e) => handleCoverageInputChange(e, "fleetSize", "text")}
                                />
                            </div>
                        </div>
                    </div>
                ...
                <Modal.Footer>
                    <Button variant="primary" className="btn border w-100" onClick={handleCoverageEditModal}>Close </Button>
                    <Button variant="primary" className="btn btn-primary w-100" onClick={handleUpdateCoverage}>Save changes</Button>
                </Modal.Footer>
            </Modal>
        )
    }
    ...
    const viewIncludedSerialNoModal = () => {
        return (
            <Modal show={showIncludedSerialNoModal} onHide={handleIncludedSerialNoModal} size="lg" centered>
                <Modal.Header className="align-items-center">
                    <div> <Modal.Title>Included Serial No</Modal.Title></div>
                    <div>
                        <Link className=" btn bg-primary text-white cursor" onClick={handleAddMoreSerialNoDataList}>Add New</Link>
                    </div>
                </Modal.Header>
                <Modal.Body className="included_table">
                    <DataTable
                ...
                <Modal.Footer>
                    <Button variant="primary" onClick={handleIncludedSerialNoModal}>Close</Button>
                    <Button variant="primary" onClick={handleUpdateIncludedSerialNo}>Save changes</Button>
                </Modal.Footer>
            </Modal>
        )
    }
    ...
    const viewSearchSerialNoModal = () => {
        return (
            <Modal show={showSerialNoSearchModal} onHide={handleShowSerialNoSearchModal} centered>
                <Modal.Header className="align-items-center">
                    ...
                    <div className="w-100">
                        <div className="d-flex align-items-center bg-light-dark w-100 border-radius-10">
                            <div className="d-flex justify-content-between align-items-center p-3 border-radius-10 w-100 border-right">
                                <div className="w-100">
                                    <input className="p-2 w-100" type="text" placeholder="Search by Customer Id" autoComplete="off"
    ...
    const columns = [
        ...
        },
        {
            ...
            cell: (row, i) => (
                <div>
                    <Link onClick={() => handleEditCoverage(i, row)} className="btn-svg text-white cursor mx-2 cursor">
                        <svg
                            version="1.1"
                    ...
                    <Link className="btn-svg text-white cursor mr-2 " onClick={() => handleDeleteCoverage(row)}>
                        <svg
                            data-name="Layer 41"
                            id="Layer_41"
                            viewBox="0 0 50 50"
                    ...
                    <Link className="btn-svg text-white cursor" onClick={() => handleShowIncludeSerialNoModelBox(i, row)}>
                        <svg
                            data-name="Layer 1"
                            id="Layer_1"
                            viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg"
                            style={{ fill: "none", width: "18px", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2px", }}
                        >
                            <title />
                ...
                <div className="date-box tabledate-box">
                    <MuiPickersUtilsProvider utils={DateFnsUtils}>
                        <DatePicker
                            ...
                            label=""
                            value={row.startDate}
                            onChange={(e) => handleIncludeSerialNoTextChange(e, i, row, "startDate")}
                        />
                ...
                <div className="date-box tabledate-box">
                    <MuiPickersUtilsProvider utils={DateFnsUtils}>
                        <DatePicker
                            ...
                            label=""
                            value={row.endDate}
                            onChange={(e) => handleIncludeSerialNoTextChange(e, i, row, "endDate")}
                        />
                    </MuiPickersUtilsProvider>
                </div>
            ),
