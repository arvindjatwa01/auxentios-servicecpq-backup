...
export const HomePage = () => {
  ...
  const savedTasksColumns = [
    ...
    },
    {
      ...
      flex: 1,
      renderCell: (params) => (
        <div style={{ fontSize: 14, backgroundColor:  colorStatus[params.row.status], paddingInline: 5, paddingBlock: 2, borderRadius:6 }} >
          {params.row.status}
        </div>)
    },
    {
            ...
            <Grid item xs={3}>
              ...
              <Card className="mr-2" sx={{borderRadius:4, marginTop: 7, height: 400}} variant="outlined">
                {[
                  ...
                  >
                    <div className="row">
                      <div className="col-sm-7 text-dark">{task.taskName}</div>{" "}
