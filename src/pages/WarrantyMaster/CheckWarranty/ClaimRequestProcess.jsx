                      ...
                      <div className="card px-3 py-3 border">
                        <div className="row input-fields">
                          <div className="col-lg-12 col-md-12 col-sm-12 col-12">
                            <div className="form-group">
                              <label className="text-light-dark font-size-14 font-weight-500">
                                Has the customer followed the safety regulations
                                in the manual?
                              </label>
                              <Select
                                className="text-primary"
                              ...
                              <div className="align-items-center date-box">
                                ...
                                >
                                  <MobileDatePicker
                                    ...
                                    // maxDate={new Date()}
                                    closeOnSelect
                                    value={evaluatedByData.evaluationChangedOn}
                                    onChange={(e) =>
                                      setEvaluatedByData({
                                        ...evaluatedByData,
                      ...
                      <div className="align-items-center date-box">
                        <LocalizationProvider dateAdapter={AdapterDateFns}>
                          <MobileDatePicker
                            ...
                            onChange={(e) =>
                              handleClaimRecordSelectDataChange(e, "createdOn")
                            }
                            renderInput={(params) => (
                              <TextField
                                {...params}
                      ...
                      <div className="align-items-center date-box">
                        <LocalizationProvider dateAdapter={AdapterDateFns}>
                          <MobileDatePicker
                            ...
                            onChange={(e) =>
                              handleClaimRecordSelectDataChange(e, "updatedOn")
                            }
                            renderInput={(params) => (
                              <TextField
                                {...params}
                      ...
                      <div className="align-items-center date-box">
                        <LocalizationProvider dateAdapter={AdapterDateFns}>
                          <MobileDatePicker
                            ...
                            onChange={(e) =>
                              handleClaimRecordSelectDataChange(e, "closedDate")
                            }
                            renderInput={(params) => (
                              <TextField
                                {...params}
