                                ...
                                setWarrantyRecord([
                                    {
                                        ...responseData,
                                        modelNumber:
                                            equWarrantyData.modelNumber,
                                        serialNumber:
                                            equWarrantyData.serialNumber,
                                    },
                                ]);
                                // if (responseData.length !== 0) {
                                // handleGetEquipmentData(responseData);
                    ...
                    <GridActionsCellItem
                        icon={
                            <div
                                className="cursor"
                                onClick={() =>
                                    handlOpenWarrantyDetailsModal(params)
                                }
                            >
                                <Tooltip title="Edit">
                                    <EditOutlinedIcon />
                    ...
                    <GridActionsCellItem
                        icon={
                            <div
                                className="cursor"
                                onClick={() =>
                                    handleOpenWarrantyOverview(params)
                                }
                            >
                                                                ...
                                                                <div className="customselectsearch customize">
                                                                    <input
                                                                        ...
                                                                        onChange={(
                                                                            ...
                                                                            handleWarrantyInputSearch(
                                                                                e,
                                                                                i
                                                                            )
                                                                        }
                                                                    />
                                                                    {searchWarranty.length -
                                                                        1 ===
                                                                        i && (
                                                                        <div
