...
const WarrantyOverviewModal = ({
    ...
    const [openClaimRequestProcess, setOpenClaimRequestProcess] =
        useState(false);
            ...
            callGetApi(rUrl, (response) => {
                if (response.status === API_SUCCESS) {
                    ...
                    if (responseData.yearlyWarrantyIds.length !== 0) {
                        getYearlyWarrantyDetails(
                            responseData["yearlyWarrantyIds"][0]
                        );
                    }
                ...
                <div className="col-xl-3 col-lg-4 col-md-12 col-sm-12 border-50">
                    ...
                    <div className="card-body">
                        ...
                        <p class="card-text">
                            ...
                            elit. Corrupti labore eum quas odit, sunt ex tenetur
                            nobis neque nulla ad, vel, voluptatibus veritatis
                            repellat temporibus. Totam, amet dolore illo
                            laudantium, praesentium, fuga incidunt expedita
                            voluptatem maiores obcaecati possimus magnam vel
                            quaerat labore velit. Rem ut, et laboriosam corporis
                            fuga aut ex?
                        </p>
                    </div>
                </div>
                                    ...
                                    <div className="bg-white p-3 border-radius-10 overflow-hidden">
                                        <div className="row align-items-end">
                                            ...
                                            <ReadOnlyField
                                                ...
                                                value={
                                                    yearlyWarrantyRecord.warrantyStartUsage
                                                }
                                                className="col-lg-3 col-md-3 col-sm-6 col-12"
                                            />
                                            <ReadOnlyField
                                                ...
                                                value={
                                                    yearlyWarrantyRecord.warrantyEndUsage
                                                }
                                                className="col-lg-3 col-md-3 col-sm-6 col-12"
                                            />
                                            <ReadOnlyField
                                            ...
                                            <div className="col-lg-3 col-md-3 col-sm-6 col-12">
                                                <div className="form-group">
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={
                                                            handleYearluWarrantyRecordChange
                                                        }
                                                    />
                                                </div>
                                            </div>
                                            ...
                                            <div className="col-lg-3 col-md-3 col-sm-6 col-12">
                                                <div className="form-group">
                                                    ...
                                                    <input
                                                        ...
                                                        value={
                                                            equipmentData.modalNumber
                                                        }
                                                        name="modalNumber"
                                                        placeholder="Model Number"
                                                        // onChange={handleWarrantyRecordChange}
                                                        onChange={
                                                            handleEquipmentDataChange
                                                        }
                                                    />
                                                </div>
                                            </div>
                ...
                <div className="Add-new-segment-div p-3 border-radius-10 mb-4">
                    <div class="repairbtn-dropdown">
                        <button
                            ...
                            onClick={handleOpenCloseClaimQuestions}
                        >
                            Raise a Claim
                        </button>
                    </div>
    ...
    return (
        <>
            ...
            {openClaimQuestionModal && (
                <ClaimRequestQuestions
                    show={openClaimQuestionModal}
                    hideModal={handleOpenCloseClaimQuestions}
                    handleSnack={handleSnack}
                    setClaimOrderId={setClaimOrderId}
                    setAssesstmentId={setAssesstmentId}
                    setEvaluationId={setEvaluationId}
