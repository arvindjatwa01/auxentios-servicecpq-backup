        ...
        >
          ...
          >
            ...
            <Tab
              ...
              disabled={!isEmpty(itemRequestObj.repairKitId)}
            />
            <div className="align-items-center d-flex justify-content-center">
              <ArrowForwardIosIcon />
            </div>
            <Tab
              label="Related Kit"
              value="relatedKit"
              disabled={!isEmpty(itemRequestObj.standardJobId)}
            />
          </TabList>
        </Box>
                ...
                <div className="col-md-6 col-sm-6">
                  <div className="form-group w-100">
                    ...
                    <input
                      type="text"
                      className="form-control border-radius-10"
                      placeholder={isPortfolioItem ? "Required*" : "Optional"}
                      name="description"
...
export default CustomItemAddEdit;
