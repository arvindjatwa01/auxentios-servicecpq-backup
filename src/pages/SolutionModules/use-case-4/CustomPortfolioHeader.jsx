...
import { CONVERT_CUSTOM_PORTFOLIO_TO_QUOTE, SOLUTION_QUOTE_CREATION } from 'services/CONSTANTS';
...
const CustomPortfolioHeader = (props) => {
    const { portfolioSupportLevel, supportLevelKeyValuePair, portfolioStatus, portfolioStatusKeyValuePair,
        setIsActivePortfolio, customPortfolioId, handlePortfolioSupportLevel, handlePortfolioStatus, history } = props;
