...
import {
    ...
    Question3,
    Question4,
} from "./GuidedSolutionQuestions";

import { Tooltip, Typography } from "@mui/material";
import { DataGrid, GridActionsCellItem } from "@mui/x-data-grid";
import $ from "jquery";
import { SOLUTION_QUOTE_DETAILS, STANDARD_JOB_DETAIL } from "navigation/CONSTANTS";
...
import QuoteSolutionConfiguration from "./QuoteSolutionConfiguration ";
...
export const GuidedSolutionQuote = (props) => {
            ...
            <TabContext value={value}>
              <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
                <TabList className="custom-tabs-div" onChange={handleChange}>
                  <Tab label="Use Solution Builder" value="config" />
                  <Tab label="Use Solution Templates " value="template" />
