...
const PriceCalculatorCustomItem = (props) => {
    console.log("PriceCalculatorCustomItem props ", props);
    ...
    useEffect(() => {
        ...
        console.log("props.createdBundleItems : ", props.createdBundleItems)
        ...
        if (props.serviceOrBundlePrefix !== "SERVICE") {
            if (props.priceCalculator) {
                ...
                if (props.priceCalculator.customItemPriceDataId !== undefined) {
    ...
    const portfolioItemPriceSjIdFun = async () => {
        ...
        setPriceCalculator({
            ...
            portfolioDataId: res.data.customPortfolio.portfolioId,
        })
...
export default PriceCalculatorCustomItem