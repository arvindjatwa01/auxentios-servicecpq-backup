...
export const RepairWithSpareParts = () => {
    ...
    return (
        <>
            ...
            <div className="content-body" style={{ minHeight: '884px' }}>
                <div class="container-fluid">
                    <div className="d-flex align-items-center justify-content-between mt-2">
                        ...
                        <div>
                            <Link to="/WithSpareParts" style={{ cursor: 'pointer' }} className="btn bg-primary text-white">
                                    ...
                                    <div className="col-md-4">
                                        <div className="recent-items mt-3">
                                            <div className="d-flex justify-content-between align-items-center ">
                                                <p className="mb-0 "><FontAwesomeIcon className=" font-size-14" icon={faFileAlt} /><span className="font-weight-500 ml-2">Repair With Spare Parts</span></p>
          ...
          <h5 className="mr-4 mb-0 text-white"><span>With Spare Parts</span></h5>
