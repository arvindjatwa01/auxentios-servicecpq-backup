...
export const RepairKits = () => {
    ...
    return (
        <>
                                    ...
                                    <div className="col-md-4">
                                        <div className="recent-items mt-3">
                                            <div className="d-flex justify-content-between align-items-center ">
                                                <p className="mb-0 "><FontAwesomeIcon className=" font-size-14" icon={faFileAlt} /><span className="font-weight-500 ml-2">Kits </span></p>
          ...
          <h5 className="mr-4 mb-0 text-white"><span>Kits</span></h5>
