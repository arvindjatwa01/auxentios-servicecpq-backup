          ...
          <div className="card p-4 mt-5">
            <div className="d-flex justify-content-end align-items-center mb-0">
              <div className="text-right">
                ...
                <a href="#" className="text-primary ml-2 border-left ">
                  <span className="ml-2">
                    <AddIcon />
                  </span>
                  Add New
            ...
            <h5 className="d-flex align-items-center mb-0">
              <div className="" style={{ display: "contents" }}>
                <span className="mr-3 white-space">Operation 01</span>
              </div>
              ...
              <div className="col-md-4 col-sm-4">
                <div class="form-group">
                  ...
                  <h6 className="font-weight-600">
                    DISASSEMBLE BOMB ACEITE TRANSMISSION
                  </h6>
                </div>
              </div>
            </div>
                ...
                <div className="card border" style={{ overflow: "hidden" }}>
                  <div className="d-flex align-items-center justify-content-between mb-0 p-3 bg-primary">
                    ...
                    <div className="d-flex">
                      ...
                      <a className="ml-3 text-white svg-div">
                        <MuiMenuComponent options={activityOptions} />
                      </a>
                    </div>
                  </div>
