...
export const RepairPartlist = () => {
    ...
    return (
        <>
            ...
            <div className="content-body" style={{ minHeight: '884px' }}>
                <div class="container-fluid">
                    <div className="d-flex align-items-center justify-content-between mt-2">
                        ...
                        <div>
                            <Link to="/PartList" style={{ cursor: 'pointer' }} className="btn bg-primary text-white">
                                    ...
                                    <div className="col-md-4">
                                        <div className="recent-items mt-3">
                                            <div className="d-flex justify-content-between align-items-center ">
                                                <p className="mb-0 "><FontAwesomeIcon className=" font-size-14" icon={faFileAlt} /><span className="font-weight-500 ml-2">Part List</span></p>
          ...
          <h5 className="mr-4 mb-0 text-white"><span>Part List</span></h5>
