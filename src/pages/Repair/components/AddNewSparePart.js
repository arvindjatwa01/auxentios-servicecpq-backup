                    ...
                    <div className="col-md-6 col-sm-6">
                      <div className="form-group w-100">
                        ...
                        <input
                          type="text"
                          className="form-control border-radius-10"
                          value={props.sparePart.salesUnit}
                          onChange={(e) =>
                            props.setSparePart({
                              ...props.sparePart,
                    ...
                    <div className="col-md-6 col-sm-6">
                      <div className="form-group w-100">
                        ...
                        <input
                          ...
                          value={parseFloat(props.sparePart.extendedPrice).toFixed(2)}
