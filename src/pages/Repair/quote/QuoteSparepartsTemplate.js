...
import { SPARE_PARTS_QUOTE_REVIEWED } from "navigation/CONSTANTS";

const QuoteSparepartsTemplate = () => {
...
const handleChangedrop2 = (event) => {
  ...
  return (
    ...
    <div className="card p-4 mt-5">
        ...
        pagination />
        <div className=" col-md-12  col-sm-12">
            <a href={SPARE_PARTS_QUOTE_REVIEWED} className="btn text-white bg-primary pull-right">Next</a>
        </div>
        </div>
...
export default QuoteSparepartsTemplate;