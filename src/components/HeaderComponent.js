          ...
          <div className="header-right">
            <ul className="clearfix">
              ...
              <a
                ...
                <div className="drop-down animated fadeIn dropdown-menu dropdown-notfication" style={{minWidth: "600px !important"}}>
                  ...
                  <div className="row search-dropdown-list">
                      ...
                      <div className="dropdown-item bg-light-grey border cursor-pointer overflow-hidden" onClick={() => history.push("/RepairWithSpareParts")} style={{ cursor: "pointer" }} >
                        <span className="span-icon">
                          <svg
                            id="uuid-7dbd4a75-0a07-4ebd-ae99-a9c37850cf3f"
                            xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div className="mt-2">Repair With Spare Parts</div></div>
                      </div>
                      <div className="col-md-2 col-sm-2 ">
                      <div className="dropdown-item cursor-pointer overflow-hidden bg-light-grey border" onClick={() => history.push("/RepairWithoutSpareParts")} style={{ cursor: "pointer" }}>
                        <span className="span-icon">
                          <svg
                            id="uuid-f3f687df-4645-4e7f-87f1-5ccb3e8264e2"
                            xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div className="mt-2">Repair Without Spare Parts</div>
                      </div>
                      </div>
                     
                      <div className="col-md-2 col-sm-2">
                      <div className="dropdown-item bg-light-grey border cursor-pointer" onClick={() => history.push("/RepairStandardJobs")} style={{ cursor: "pointer" }}>
                        <span className="span-icon">
                          <svg
                            id="uuid-71879914-eb74-479f-b04a-3a9b28cfee15"
                            xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div className="mt-2">Standard Job</div>
                      </div>
                      </div>
                    </div>
                  {/* <div className="search-drop-div search-dropdown-list">
