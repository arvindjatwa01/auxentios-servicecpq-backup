              ...
              <li><a className="has-arrow" href="#" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                  <li>
                    ...
                    <ul aria-expanded="false">
                      <li><NavLink to="/WithoutSpareParts" activeClassName="active">
                      ...
                      <li><NavLink to="/BulidRepairOptions" activeClassName="active">
                  ...
                  <li><NavLink to="/PartList" activeClassName="active">
                  ...
                  <li><NavLink to="/StandardJobs" activeClassName="active">
                  ...
                  <li><NavLink to="/Kits" activeClassName="active">
